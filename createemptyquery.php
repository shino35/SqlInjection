  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
                ...
                <tr><div class="form-group"><td  id="updsub"><a href="logout.php"><input type="submit" class="btn btn-primary" value="Submit"></a></td><td id="updsub"> <a href="studentstable.php" class="btn btn-secondary ml-2">Back</a></div></td></tr>
